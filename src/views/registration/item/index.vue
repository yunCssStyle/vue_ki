...
import { ItemColumn } from '@/data/column'
...
<template>
  <div class="box">
    ...
    <el-dialog v-model="RegistrationDialog" title="품목 등록" width="376px" align-center>
      <RegistrationModal @cancel="RegistrationDialog = false" />
    </el-dialog>
    <el-dialog v-model="modifyDialog" title="품목 수정" width="376px" align-center>
