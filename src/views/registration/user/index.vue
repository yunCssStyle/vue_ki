...
import { UserColumn } from '@/data/column'
...
<template>
  <div class="box">
      ...
      <div class="topBtn">
        ...
        <el-button
          ...
          @click="
            showAlert({
              title: '사용자 삭제',
              text: '<span>user1</span>을 삭제하시겠습니까?',
              thenCallback: () => {
                console.log('출력')
              }
            })
    ...
    <el-dialog v-model="RegistrationDialog" title="사용자 등록" width="500px" align-center>
      <RegistrationModal @cancel="RegistrationDialog = false" />
    </el-dialog>
    <el-dialog v-model="modifyDialog" title="사용자 수정" width="480px" align-center>
